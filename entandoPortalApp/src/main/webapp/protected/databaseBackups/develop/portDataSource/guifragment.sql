...
<#else>
	...
	<form action="<@wp.url page="www.google.com"/>" method="post" class="form-horizontal margin-medium-top">
...
INSERT INTO guifragment (code,widgettypecode,plugincode,gui,defaultgui,locked) VALUES ('PGD','PGD',NULL,'<#assign wp=JspTaglibs["/aps-core"]>

  <app-root></app-root>
<span id="userUrl" style="display:none"><@wp.url page="users"/></span>
<script type="text/javascript" src="<@wp.resourceURL />static/angular-resources/portalGrid/runtime.js"></script>
<script type="text/javascript" src="<@wp.resourceURL />static/angular-resources/portalGrid/polyfills.js"></script>
<script type="text/javascript" src="<@wp.resourceURL />static/angular-resources/portalGrid/styles.js"></script>
<script type="text/javascript" src="<@wp.resourceURL />static/angular-resources/portalGrid/vendor.js"></script>
<script type="text/javascript" src="<@wp.resourceURL />static/angular-resources/portalGrid/main.js"></script>',NULL,0);
INSERT INTO guifragment (code,widgettypecode,plugincode,gui,defaultgui,locked) VALUES ('USR','USR',NULL,'<#assign wp=JspTaglibs["/aps-core"]>

  <app-root></app-root>
<script type="text/javascript" src="<@wp.resourceURL />static/angular-resources/users/runtime.js"></script>
<script type="text/javascript" src="<@wp.resourceURL />static/angular-resources/users/polyfills.js"></script>
<script type="text/javascript" src="<@wp.resourceURL />static/angular-resources/users/styles.js"></script>
<script type="text/javascript" src="<@wp.resourceURL />static/angular-resources/users/vendor.js"></script>
<script type="text/javascript" src="<@wp.resourceURL />static/angular-resources/users/main.js"></script>',NULL,0);
INSERT INTO guifragment (code,widgettypecode,plugincode,gui,defaultgui,locked) VALUES ('LGN','LGN',NULL,'<#assign wp=JspTaglibs["/aps-core"]>
<h1><@wp.i18n key="RESERVED_AREA" /></h1>
<#if (Session.currentUser.username != "guest") >
	<p><@wp.i18n key="WELCOME" />, <em>${Session.currentUser}</em>!</p>
	<#if (Session.currentUser.entandoUser) >
