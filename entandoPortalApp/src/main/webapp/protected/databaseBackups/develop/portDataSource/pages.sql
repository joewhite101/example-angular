...
INSERT INTO pages (code,parentcode,pos,groupcode) VALUES ('users','homepage',2,'free');
INSERT INTO pages (code,parentcode,pos,groupcode) VALUES ('userdetailspage','homepage',3,'administrators');
